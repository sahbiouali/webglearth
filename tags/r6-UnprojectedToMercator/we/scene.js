...
we.Scene = function(context) {
  ...
  if (!gl.getProgramParameter(shaderProgram, gl.LINK_STATUS)) {
    we.scene.logger.shout('Could not initialise shaders');
  }
  ...
  we.plane = new we.gl.Plane(context, 4, 4);
  we.texture = we.gl.Texture.load(context, 'world1024_lines.jpg');
